...
download.addEventListener("mousedown", function () {
  ...
  document.getElementById("imagesvg").innerHTML = getSVGContents(iSVG) + getSVGContents(dSVG);
...
function getSVGContents(inputString) {
  ...
  let svgDOM = domParser.parseFromString(source, "text/xml").getElementsByTagName("svg")[0];
